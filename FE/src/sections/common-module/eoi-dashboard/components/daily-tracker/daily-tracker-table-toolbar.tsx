...
export interface DailyTrackerFilters {
...
type Props = {
  columnManager?: any;
  filters: DailyTrackerFilters;
  onApplyFilters?: (newFilters: DailyTrackerFilters) => void;
  roleFilters?: RoleFilter[];
  campaignOptions: { label: string; value: string }[];
};

const DailyTrackerTableToolbar = ({
  columnManager,
  filters,
  onApplyFilters,
  roleFilters,
  ...
  const [filterState, setFilterState] = useState<DailyTrackerFilters>({
    campaign: null,
    startDate: null,
    endDate: null,
  });
...
export default DailyTrackerTableToolbar;
