...
const BatchRecordsToolbar = ({ columnManager, search, onSearchChange }: Props) => (
  <Box
    sx={{
      p: 1.5,
      gap: 1,
  ...
  >
    ...
    >
      <SearchInput
        ...
        placeholder={uiText.batchViewRecords.searchPlaceholder}
      />
    </Box>
...
export default BatchRecordsToolbar;
