...
const BatchVoucherListToolbar = ({ columnManager, search, onSearchChange }: Props) => (
  <Box
    sx={{
      p: 1.5,
      gap: 1,
  ...
  >
    ...
    >
      <SearchInput
        ...
        placeholder={uiText.batchVoucherListing.searchPlaceholder}
      />
    </Box>
...
export default BatchVoucherListToolbar;
