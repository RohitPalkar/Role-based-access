...
const MuiAutocomplete: Components<Theme>['MuiAutocomplete'] = {
  ...
  styleOverrides: {
    /**
     * Autocomplete list is portaled; default z-index matches modal (1300) and sits
     * behind CustomPopover (modal+1). Raise so dropdowns inside filter popups paint on top.
     */
    popper: ({ theme }) => ({
