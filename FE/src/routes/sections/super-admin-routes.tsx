...
import { superAdminNav } from 'src/layouts/config-nav-dashboard';
...
const SfdcLogsListView = lazy(() => import('src/sections/admin/sfdc-logs/sfdc-logs-list-view'));
...
const layoutContent = (
  <DashboardLayout navData={superAdminNav}>
...
export const superAdminRoutes = {
  ...
  children: [
    ...
    { path: 'sfdc-logs', element: <PermissionGuard moduleCode="sfdc-logs"><SfdcLogsListView /></PermissionGuard> },
    // Batch manager
