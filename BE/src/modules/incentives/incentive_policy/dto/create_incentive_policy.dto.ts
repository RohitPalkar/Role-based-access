...
// Slab DTO for *creating* an incentive slab
export class CreateIncentiveSlabDto {
  @IsOptional()
  ...
  @Max(100000, { message: 'Launch End Range cannot exceed 100,000.' })
  ...
  @Max(100000, { message: 'Sustenance End Range cannot exceed 100,000.' })
...
// Main DTO for creating an incentive structure
export class CreateIncentivePolicyDto {
  ...
  @Min(0, { message: 'Max Payable Incentive must be at least 0.' })
  @Max(9999999.999, {
    message:
      'Max Payable Incentive must be a valid amount with up to 2 decimal places.',
  })
  ...
  incentiveSlabs: CreateIncentiveSlabDto[];
}
