...
export class InsertQueueIdAssignedEmailTemplate1763050310968 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      VALUES (
        ...
        <p><a href="{THANK_YOU_PAGE_LINK}">Thank you - page link</a></p>
