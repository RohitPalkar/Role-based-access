...
export class ChangeInrmDashboardListing1763975296708 implements MigrationInterface {
...
SET @limitQuery = '';
        ...
        SET @sql = CONCAT(
            ...
            FROM (
                SELECT 
                    ...
                    SUM(v.voucher_status NOT IN("1-Form Link Shared","2-Form fill in progress")) AS collectedEoiCount,
                    SUM(v.voucher_status IN("2-Form fill in progress")) AS inProgressEoiCount,
                       SUM(
        CASE 
            WHEN v.voucher_status NOT IN ("1-Form Link Shared","2-Form fill in progress") 
    ...
    SUM(
        ...
        END
                    ...
                    SUM(((v.voucher_status IN ("5-MIS-Resubmission requested","8-CRM-Resubmission requested","3-Form Submitted","9-Updated as per CRM","6-Updated as per MIS")) OR (v.finance_status IN("Rejected", "Not Realized")))) AS pendingRMCount,
